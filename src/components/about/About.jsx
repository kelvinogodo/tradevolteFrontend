  ...
  return (
    <div className='about-section' id='about'>
        ...
        <div className="about-img-container">
            <video controls src="/WhatsApp Video 2023-03-12 at 14.53.31.mp4" data-aos="fade-up" className='about-img'/>
        </div>
        </div>
    </div>
  )
