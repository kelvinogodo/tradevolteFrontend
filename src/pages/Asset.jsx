    ...
    const [tabs,setTabs] = useState([
        {
            ...
            body:[
            "In the dynamic world of investment, Tradevolte shines as a leading company harnessing the potential of forex trading to generate consistent profits. With a diverse team of skilled traders and cutting-edge algorithms, they leverage market trends to maximize returns. By strategically buying and selling currencies, they exploit fluctuations in exchange rates to their advantage. Employing rigorous risk management and extensive research, Tradevolte ensures a balanced portfolio, offering investors an opportunity to passively grow their wealth. Experience the power of forex trading and discover a new realm of financial possibilities with Tradevolte."],
            active:true,
            icon:GiChart,
        ...
        },
        {
            ...
            body:[
                "In the ever-evolving world of finance, Tradevolte has emerged as a pioneering force, harnessing the power of cryptocurrencies to generate consistent profits. By skillfully navigating the volatile crypto market, the company utilizes strategic investment approaches to maximize returns for its investors. Leveraging cutting-edge algorithms, in-depth market analysis, and expert insights, Tradevolte identifies lucrative opportunities and executes well-timed trades. Through disciplined risk management and diversification, the company capitalizes on the inherent potential of cryptocurrencies, offering investors a reliable avenue to unlock the wealth of the digital economy."],
            active:false,
            icon:SiBitcoin,
        ...
        },
        {
            ...
            body:[
                "In the dynamic realm of investing, Tradevolte stands tall as a company that strategically taps into the potential of oil and gas ventures. Through meticulous analysis and expert decision-making, the company identifies lucrative opportunities within the energy sector, capitalizing on the ever-present demand for these vital resources. By investing in carefully selected oil and gas projects, Tradevolte generates profit through the production and sale of these valuable commodities. With a proven track record, their astute investment approach positions them as a trusted avenue for investors seeking to benefit from the enduring profitability of the oil and gas industry."],
            active:false,
            icon:GiOilPump,
